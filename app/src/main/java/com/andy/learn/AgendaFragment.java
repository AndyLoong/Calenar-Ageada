...
import com.andy.learn.CalendarController.EventType;
import com.andy.learn.CalendarController.EventHandler;
import com.andy.learn.CalendarController.EventInfo;
import com.andy.learn.CalendarController.ViewType;
...
public class AgendaFragment extends Fragment implements EventHandler,
    ...
    public void onResume() {
        ...
        SharedPreferences prefs = getActivity().getSharedPreferences(Utils.SHARED_PREFS_NAME, Context.MODE_PRIVATE);
        boolean hideDeclined = prefs.getBoolean(Utils.KEY_HIDE_DECLINED, false);
